print("Welcome ! This program allows the migration of Deezer playlist into Spotify playlist and make it a database. If you don't want a database, please use the code 'PlaylistDeezerToSpotify.py'. Otherwise, make sure you have Xampp installed. The instructions are in English, but the comments are in French : don't hesitate to ask questions on the Github in case of misunderstanding :)\n")
